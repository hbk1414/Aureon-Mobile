...
interface TrendsDetailScreenProps {
  onClose: () => void;
}

export default function TrendsDetailScreen({ onClose }: TrendsDetailScreenProps) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Monthly Trends</Text>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.insightsCard}>
          ...
          <View style={styles.insightItem}>
            ...
            <Text style={styles.insightText}>
              Your income has increased by 8% this month compared to your 3-month average.
            </Text>
          </View>
        </View>
